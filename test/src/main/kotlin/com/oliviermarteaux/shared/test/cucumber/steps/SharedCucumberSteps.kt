 ...
 *
 * This class is designed to interact with Compose UI elements through a [com.oliviermarteaux.shared.test.di.ComposeRuleHolderInterface],
 * enabling automated tests to perform actions and assertions in a human-readable, BDD-style format.
 *
 * ### Constructor:
 * @param composeRuleHolder An implementation of [com.oliviermarteaux.shared.test.di.ComposeRuleHolderInterface] that provides the
